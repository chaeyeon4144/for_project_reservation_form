    ...
    <div class="form-container">
      ...
      <form @submit.prevent="handleSubmit">
        <div class="form-section">
          ...
          <div class="service-types">
            <label
              ...
              <input type="radio" :value="service.id" required v-model="formData.serviceType" />
        ...
        <div class="form-actions">
          ...
          <button type="submit" class="submit-btn" :disabled="!isFormVaild">예약하기</button>
        </div>
      </form>
    </div>
    ...
    <div class="modal" v-if="showConfirmModal">
      <div class="modal-content">
        ...
        <div class="modal-actions">
          <button class="cancel-btn" @click="showConfirmModal = false">취소</button>
...
// 예약 가능한 시간대 목록
const availableTimes = ref(["09:00", "10:00", "11:00", "13:00", "14:00", "15:00", "16:00", "17:00"]);
